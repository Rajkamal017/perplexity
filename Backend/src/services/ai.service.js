    ...
    const response = await agent.invoke({
        messages: [
            new SystemMessage(`
                ...
                if the question requires up-to-date information, use the "searchInternet" tool to get the latest data from the internet, and then use that data to answer the question.
            `),
            ...(messages.map(msg => {
            if (msg.role === "user") {
